...
public class Line extends Observable {
    ...
    public void setHome() {
        ...
        this.setChanged();
        // notificamos que ha habido un cambio
        this.notifyObservers(KEY.HOME_VAL);
    }
    ...
    public void setEnd() {
        ...
        this.setChanged();
        // notificamos que ha habido un cambio
        this.notifyObservers(KEY.END_VAL);
    }
    ...
    public void leftArrow() {
        if (cursorPosition > 0) {
            ...
            this.setChanged();
            // notificamos que ha habido un cambio
            this.notifyObservers(KEY.LEFT_VAL);
        }
    }
    ...
    public void rightArrow() {
        if (cursorPosition < characters.size()) {
            ...
            this.setChanged();
            // notificamos que ha habido un cambio
            this.notifyObservers(KEY.RIGHT_VAL);
        }
    }
    ...
    public void backspace() {
        if (cursorPosition > 0) {
            ...
            this.setChanged();
            // notificamos que ha habido un cambio
            this.notifyObservers(KEY.BSK_VAL);
        }
    }
    ...
    public void delete() {
        if (cursorPosition < characters.size()) {
            ...
            this.setChanged();
            // notificamos que ha habido un cambio
            this.notifyObservers(KEY.DEL_VAL);
        }
    }
